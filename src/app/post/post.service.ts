...
export class PostService {
  ...
  create(post): Observable<Post> {
    return this.httpClient
      .post<Post>(this.apiURL + '/posts/', JSON.stringify(post), this.httpOptions)
  ...
  getComments(id): Observable<Comment[]> {
    return this.httpClient
      .get<Comment[]>(this.apiURL + '/posts/' + id + '/comments')
      .pipe(catchError(this.errorHandler));
  }

  update(id, post): Observable<Post> {
    return this.httpClient
      .put<Post>(this.apiURL + '/posts/' + id, JSON.stringify(post), this.httpOptions)
      .pipe(catchError(this.errorHandler));
  }
